...
export default () => {
  return (
    <Segment basic style={mainStyleBg} inverted>
      ...
      <h2 style={textStyle}>We are excited to announce that we are partnering with our friends at <strong>StartEngine</strong> to conduct our pre-sale! We are selling 107,000 shares of common stock in CrowdCoverage, Inc., for a price of $1 per share.</h2>
      <h2 style={textStyle}>$100 is available for purchase, with each $100 spent granting the user a bonus of 8,000 COVR tokens which can be used on our platform!</h2>
      <h2 style={textStyle}>For more info and to join the pre sale click on the StartEngine link below!</h2>
      <Button>
        <Link route={`https://www.startengine.com/crowd-coverage`} as='a'>StartEngine</Link>
      </Button>
      <Button>
        <Link prefetch route={`/home`} as='a'>Go to our site</Link>
      </Button>
